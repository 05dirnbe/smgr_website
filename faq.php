    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <ul class="nav nav-tabs faq-cat-tabs">
                ...
                <li><a href="#faq-cat-3" data-toggle="tab">Category #3</a></li>
            </ul>
                    ...
                    <div class="panel-group" id="accordion-cat-1">
                        ...
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-1-sub-6" class="panel-collapse collapse">
                                <div class="panel-body">
                                    Please let us know that you are ready. You will have to decide whether you want us
                                    to host
                                    your data on our servers, or whether you prefer us to put up a link to your server
                                    hosting the data.
                        ...
                        <div class="panel panel-default panel-faq">
                            <div class="panel-heading">
                                <a data-toggle="collapse" data-parent="#accordion-cat-1" href="#faq-cat-1-sub-20">
                                    <h4 class="panel-title">
                                        What happens to my data after submission? Do I have to give up control over my
                                        data?
                                        <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                                    </h4>
                                </a>
                            ...
                            <div id="faq-cat-1-sub-20" class="panel-collapse collapse">
                                <div class="panel-body">
                                    ...
                                    documented.
                                    If this is the case, we will add it to the data sets available via the SMGR project
                                    page.
                        ...
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-1-sub-7" class="panel-collapse collapse">
                                <div class="panel-body">
                                    At any point in time your data remains your data and you can instruct us to remove
                                    it from the SMGR.
                                    This could be appropriate for example, if something was discovered that renders the
                                    data erroneous.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-1-sub-10" class="panel-collapse collapse">
                                <div class="panel-body">
                                    ...
                                    networks,
                                    it is probably foolish to expect a large amount of contributors out of the blue. As
                                    a result,
                                    ...
                                    upload processes,
                                    are simply overkill at the moment. However, such features may well be added in the
                                    future provided
