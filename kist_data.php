...
<body>
  ...
  <div class="container">
    ...
    <li>A small amount of dried <em>P. Polycephalum</em> (HU195xHU200) sclerotia crumbs is lined up along the short edge of the dish, see <strong>Figure 2</strong>. The dish is put into a large light-proof box</li>
    <li>After approximately 14 hours the plasmodium has resuscitated and starts exploring the available space towards the far side of the dish. Typically, the apical zone needs to cover a distance of several centimeters before network formation can be observed properly, see <strong>Figure 3</strong></li>
    <li>For the next 30 hours we take a top-view image of the growing plasmodium and the changing network every 120 seconds from a fixed position. A typical obtained image is seen in <strong>Figure 4</strong>. We stop capturing when the apical zone is about to reach the far side of the dish, which is outside of the observed area.</li>
    <li>After obtaining sequences of images showing the characteristic networks of <em>P. Polycephalum</em>, we use a software called <a href="http://nefi.mpi-inf.mpg.de">NEFI</a> to compute corresponding sequences of graph representations of the depicted structures within a predefined region of interest, see <strong>Figure 5</strong>. The graphs store precise information of the length and width of the edges as well as the coordinates of the nodes in the plane. A typical resulting unfiltered graph is seen in <strong>Figure 6</strong></li>
